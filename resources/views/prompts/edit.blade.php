        ...
        <div class="form-group">
            ...
            <div class="flex gap-4 mt-1">
                <label class="flex items-center gap-2 cursor-pointer">
                    <input type="radio" name="visibility" value="private" {{ old('visibility', $prompt->visibility) == 'private' ? 'checked' : '' }}>
                    <span>Private (Only you)</span>
                </label>
                <label class="flex items-center gap-2 cursor-pointer">
                    <input type="radio" name="visibility" value="public" {{ old('visibility', $prompt->visibility) == 'public' ? 'checked' : '' }}>
